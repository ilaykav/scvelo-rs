...
**Run on:** AMD EPYC 7763 64-Core Processor, 2C/4T, 16.8 GB RAM, Linux-6.17.0-1018-azure-x86_64-with-glibc2.39, Python 3.12.13 (github-actions)  
**Generated:** 2026-07-05 08:26 UTC
...
|---|---:|---:|---|---|---|---:|---|
| speed_recover_dynamics_5k | 5,000 | 50 | recover_dynamics | 26.44 s | 4.02 s | 6.58× | - |
| speed_velocity_20k | 20,000 | 100 | recover_dynamics,velocity | 222.63 s | 36.29 s | 6.13× | - |
| speed_velocity_graph_20k | 20,000 | 100 | recover_dynamics,velocity,velocity_graph | 230.02 s | 37.35 s | 6.16× | - |
| speed_full_pipeline_50k (LONG) | 50,000 | 100 | recover_dynamics,velocity,velocity_graph | 669.68 s | 113.11 s | 5.92× | ✓ PASS (14/14) |
| speed_recover_dynamics_100k (LONG) | 100,000 | 30 | recover_dynamics | 370.59 s | 75.5 s | 4.91× | ✓ PASS (13/13) |
| speed_compute_dynamics_5k | 5,000 | 50 | compute_dynamics | 0.08 s | 0.01 s | 8.0× | - |

#### Memory (peak heap)

| benchmark | cells | genes | ops | scvelo | scvelo-rs | ratio | bit-exact |
|---|---:|---:|---|---|---|---:|---|
| mem_recover_dynamics_5k | 5,000 | 50 | recover_dynamics | 40.0 MB | 0.0 MB | +40.0 MB | - |
| mem_velocity_graph_20k | 20,000 | 100 | recover_dynamics,velocity,velocity_graph | 1635.2 MB | 507.5 MB | +1127.7 MB | - |
| mem_steady_state_layers | 5,000 | 200 | recover_dynamics,velocity,velocity_graph | 232.4 MB | 0.0 MB | +232.4 MB | - |
| mem_full_pipeline_50k (LONG) | 50,000 | 100 | recover_dynamics,velocity,velocity_graph | 4594.1 MB | 1482.6 MB | +3111.5 MB | - |
| mem_oom_crash_100k (LONG) | 100,000 | 30 | recover_dynamics,velocity,velocity_graph | 7081.3 MB | 1557.5 MB | +5523.8 MB | - |

#### Vendor workflows (real-world end-to-end)

| workflow | cells | genes | scvelo | scvelo-rs | speedup | bit-exact |
|---|---:|---:|---|---|---:|---|
| vendor_pancreas_tutorial (LONG) | 3,696 | 2000 | 432.57 s | 72.1 s | 6.0× | ✓ PASS (15/15) |
| vendor_cellrank2_hematopoiesis (LONG) | 24,000 | 2000 | 359.25 s | 120.57 s | 2.98× | ✓ PASS (15/15) |
