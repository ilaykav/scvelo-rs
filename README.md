...
**Run on:** AMD EPYC 9V74 80-Core Processor, 2C/4T, 16.8 GB RAM, Linux-6.17.0-1015-azure-x86_64-with-glibc2.39, Python 3.12.13 (github-actions)  
...
|---|---:|---:|---|---|---|---:|---|
| speed_recover_dynamics_5k | 5,000 | 50 | recover_dynamics | 24.37 s | 4.01 s | 6.08× | - |
| speed_velocity_20k | 20,000 | 100 | recover_dynamics,velocity | 194.4 s | 36.13 s | 5.38× | - |
| speed_velocity_graph_20k | 20,000 | 100 | recover_dynamics,velocity,velocity_graph | 203.63 s | 37.33 s | 5.45× | - |
| speed_full_pipeline_50k (LONG) | 50,000 | 100 | recover_dynamics,velocity,velocity_graph | 598.18 s | 109.47 s | 5.46× | ✗ DRIFT (12/14) |
| speed_recover_dynamics_100k (LONG) | 100,000 | 30 | recover_dynamics | 338.85 s | 72.53 s | 4.67× | ✓ PASS (13/13) |
...
| benchmark | cells | genes | ops | scvelo | scvelo-rs | ratio | bit-exact |
|---|---:|---:|---|---|---|---:|---|
| mem_recover_dynamics_5k | 5,000 | 50 | recover_dynamics | 79.7 MB | 0.0 MB | +79.7 MB | - |
| mem_velocity_graph_20k | 20,000 | 100 | recover_dynamics,velocity,velocity_graph | 1732.7 MB | 554.8 MB | +1177.9 MB | - |
| mem_steady_state_layers | 5,000 | 200 | recover_dynamics,velocity,velocity_graph | 214.1 MB | 39.9 MB | +174.2 MB | - |
| mem_full_pipeline_50k (LONG) | 50,000 | 100 | recover_dynamics,velocity,velocity_graph | 4655.2 MB | 1433.6 MB | +3221.6 MB | - |
| mem_oom_crash_100k (LONG) | 100,000 | 30 | recover_dynamics,velocity,velocity_graph | 7028.2 MB | 2556.9 MB | +4471.3 MB | - |

#### Vendor workflows (real-world end-to-end)

| workflow | cells | genes | scvelo | scvelo-rs | speedup | bit-exact |
|---|---:|---:|---|---|---:|---|
| vendor_pancreas_tutorial (LONG) | 3,696 | 2000 | 404.76 s | 71.45 s | 5.66× | ✗ DRIFT (6/15) |
| vendor_cellrank2_hematopoiesis (LONG) | 24,000 | 2000 | 339.72 s | 116.49 s | 2.92× | ✗ DRIFT (6/15) |
