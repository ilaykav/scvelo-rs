...
**Generated:** 2026-07-03 08:22 UTC
...
|---|---:|---:|---|---|---|---:|---|
| speed_recover_dynamics_5k | 5,000 | 50 | recover_dynamics | 24.88 s | 3.97 s | 6.27× | - |
| speed_velocity_20k | 20,000 | 100 | recover_dynamics,velocity | 204.49 s | 35.71 s | 5.73× | - |
| speed_velocity_graph_20k | 20,000 | 100 | recover_dynamics,velocity,velocity_graph | 213.32 s | 36.85 s | 5.79× | - |
| speed_full_pipeline_50k (LONG) | 50,000 | 100 | recover_dynamics,velocity,velocity_graph | 626.35 s | 111.89 s | 5.6× | ✓ PASS (14/14) |
| speed_recover_dynamics_100k (LONG) | 100,000 | 30 | recover_dynamics | 355.7 s | 74.7 s | 4.76× | ✓ PASS (13/13) |
...
| mem_velocity_graph_20k | 20,000 | 100 | recover_dynamics,velocity,velocity_graph | 1609.9 MB | 511.7 MB | +1098.2 MB | - |
| mem_steady_state_layers | 5,000 | 200 | recover_dynamics,velocity,velocity_graph | 215.1 MB | 0.0 MB | +215.1 MB | - |
| mem_full_pipeline_50k (LONG) | 50,000 | 100 | recover_dynamics,velocity,velocity_graph | 4752.1 MB | 1381.4 MB | +3370.7 MB | - |
| mem_oom_crash_100k (LONG) | 100,000 | 30 | recover_dynamics,velocity,velocity_graph | 7104.6 MB | 1605.4 MB | +5499.2 MB | - |

#### Vendor workflows (real-world end-to-end)

| workflow | cells | genes | scvelo | scvelo-rs | speedup | bit-exact |
|---|---:|---:|---|---|---:|---|
| vendor_pancreas_tutorial (LONG) | 3,696 | 2000 | 408.84 s | 70.62 s | 5.79× | ✓ PASS (15/15) |
| vendor_cellrank2_hematopoiesis (LONG) | 24,000 | 2000 | 344.09 s | 116.86 s | 2.94× | ✓ PASS (15/15) |
